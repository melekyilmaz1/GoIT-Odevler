...
import type { ModifyVpcEndpointPayerResponsibilityRequest, ModifyVpcEndpointPayerResponsibilityResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifyVpcEndpointPayerResponsibilityCommand_base: {
    new (input: ModifyVpcEndpointPayerResponsibilityCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEndpointPayerResponsibilityCommandInput, ModifyVpcEndpointPayerResponsibilityCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ModifyVpcEndpointPayerResponsibilityCommandInput): import("@smithy/core/client").CommandImpl<ModifyVpcEndpointPayerResponsibilityCommandInput, ModifyVpcEndpointPayerResponsibilityCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
