...
declare const GetDefaultCreditSpecificationCommand_base: {
    new (input: GetDefaultCreditSpecificationCommandInput): import("@smithy/core/client").CommandImpl<GetDefaultCreditSpecificationCommandInput, GetDefaultCreditSpecificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDefaultCreditSpecificationCommandInput): import("@smithy/core/client").CommandImpl<GetDefaultCreditSpecificationCommandInput, GetDefaultCreditSpecificationCommandOutput, import("..").EC2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
